...
const hostnames = [
  {
      ...
      customDomain: 'www.multisite_poc_sitea.localhost|next12-multisite-global.vercel.app',
    ...
    },
    {
      ...
      customDomain: 'www.multisite_poc_siteb.localhost|next12-multisite-uk.vercel.app',
      defaultForPreview: true,
    },
]
...
export async function getSitesPaths() {
  ...
  return subdomains.map((item) => {
    return { site: item.siteName, languages: item.languages,
